...
####################################################################
cycle_number = 100
m6a_bed_dir = "/data5/galaxy/project/tf_analysis/TFBS_analysis/DMR"
control_bed_dir = "/data5/galaxy/project/bam2bed_input/merged_data/discrete_bed"
result_dir = "/data5/galaxy/project/tf_analysis/TFBS_analysis/%dcycle_input" % cycle_number
