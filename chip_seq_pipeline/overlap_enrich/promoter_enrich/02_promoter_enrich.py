...
###########################################################################
gene_dir = "/data5/galaxy/project/promoter_TF_enrich/filter_by_expre_gene"
...
#
result_dir = "/data5/galaxy/project/promoter_TF_enrich/tissue_enr_result"
if not os.path.exists(result_dir):
    os.makedirs(result_dir)
#
gene_promoter_dir = "/data5/galaxy/project/promoter_TF_enrich/gene_promoter_bed"
promoter_dir = "/data5/galaxy/project/promoter_TF_enrich/promoter_bed"
...
def class_gene_according_chip(in_txt, tfbs_bed):
    command = "bedtools intersect -a stdin -b %s -F 0.6 -wa | uniq" % tfbs_bed
